...
#
# AVR_MCU (default: atmega328)
#       the teype of AVR the application is built for
# AVR_L_FUSE (NO DEFAULT)
#       the LOW fuse value for the MCU used
# AVR_H_FUSE (NO DEFAULT)
#       the HIGHT fuse value for the MCU used
# AVR_UPLOADTOOL (default: avrdude)
#       the application used to upload the program to the MCU
#       NOTE: The toolchain is currently quite specific about
#               the commands used, so it nedd tweaking.
# AVR_UPLOADTOOL_POART (default: usb)
#       the port used ofr the upload tool, e.g. usb
...
###########################################################################
set(CMAKE_SYSTEM_NAME arch-linux)
set(CMAKE_SYSTEM_PROCESSOR avr)
set(CMAKE_C_COMPILER ${AVR_CC})
set(CMAKE_CXX_COMPILER ${avr_CXX})

###########################################################################
# some necessary tools and variables for AVR builds, which may not be
# defined yet
# - AVR_UPLOADTOOL
# - AVR_UPLOAD_TOOL_PORT
# - AVR_PROGRAMMER
# - AVR_MCU
# - AVR_SIZE_ARGS
###########################################################################
...
if (NOT AVR_PROGRAMMER)
    set(
        AVR_UPLOAD_TOOL_PORT usbasp
        CACHE STRING "Set default upload tool port: usbasp"
    )
...
function(add_avr_executable EXECUTABLE_NAME)
   if(NOT ARGN)
      message(FATAL_ERROR "No source files give for ${EXECUTABLE_NAME}.")
   endif(NOT ARGN)

   # set file names
   set(elf_file ${EXECUTABLE_NAME}${MCU_TYPE_FOR_FILENMAE}.elf)
   set(hex_file ${EXECUTABLE_NAME}${MCU_TYPE_FOR_FILENMAE}.hex)
   set(map_file ${EXECUTABLE_NAME}${MCU_TYPE_FOR_FILENAME}.map)
   set(eeprom_image ${EXECUTABLE_NAME}${MCU_TYPE_FOR_FILENWAM}-eeprom.hex)
